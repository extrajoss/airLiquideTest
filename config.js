...
config.web.baseStatic = path.join(__dirname, '/public')
config.web.spreadsheet = {element: 'He', ligand: 'withLigand', energy: 'high'}
config.web.spreadsheet = {
  'He': {
    elementName: 'Helium',
    atomicNumber: '2',
    atomicWeight: '4.003',
...
config.web.helpDocument = 'https://docs.google.com/document/d/1jLpzLvHNIwmnzuLMfgerGgbYSdKGLez2ivL3ViTULss/pub'
...
config.jolecule.PREPROCESSING_SCRIPT = path.join(__dirname, '/server/jolecule/autodock2pdbES5.js')
